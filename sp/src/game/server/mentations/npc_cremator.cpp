...
ConVar	sk_cremator_dmg_immo( "sk_cremator_dmg_immo","0.685"); //Anything higher than this is OP
ConVar	sk_cremator_max_range( "sk_cremator_max_range","475");
ConVar	sk_cremator_immolator_color_r ("sk_cremator_immolator_color_r", "50");
ConVar	sk_cremator_immolator_color_g ("sk_cremator_immolator_color_g", "220");
ConVar	sk_cremator_immolator_color_b ("sk_cremator_immolator_color_b", "0");
ConVar	sk_cremator_immolator_beamsprite ("sk_cremator_immolator_beamsprite", "sprites/lgtning.vmt");
